...
export const [metricsStats, setMetricsStats] =
    createSignal<AppMetricsStats | null>(null);
export const [metricsHistory, setMetricsHistory] = createSignal<
    AppMetricsSample[]
>([]);
...
export const logger = {
    ...
    warning: (message: string, context?: string) =>
        addLog('Warning', message, context),
